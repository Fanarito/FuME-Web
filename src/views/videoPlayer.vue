...
<template>
  <div class="ui container">
    <video id="video" class="video-js" autoplay controls preload="none" poster="{{poster}}">
      <track src="http://fume.fanarito.duckdns.org/subtitles/43590e8b-af37-48c5-91ad-6447617f8c2e.vtt" kind="subtitles" srclang="en" label="English" />
      <p class="vjs-no-js">
      ...
      attached() {
        ...
        if (this.$route.params.subtitles > 0){
          ...
          /*this.$data.player.track([{
            kind: "subtitles",
            src: "http://fume.fanarito.duckdns.org/subtitles/43590e8b-af37-48c5-91ad-6447617f8c2e.vtt"
          }]);*/
        } else {
          this.$data.player.src([{
            type: "video/webm",
